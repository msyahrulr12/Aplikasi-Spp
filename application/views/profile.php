                    ...
                    <div class="profile-details-hr">
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                <div class="address-hr">
                                    <p><b>Name</b><br /> <?=$profile['nama_petugas']?></p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="address-hr">
                                    <p><b>Level</b><br /> <?=$profile['level']?></p>
                                </div>
                            </div>
                            <!-- <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="review-content-section">
                                        <form action="<?php echo site_url('/Petugas/update_profile'); ?>" method="post" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                            <input type="hidden" name="id_petugas" value="<?=$profile['id_petugas']?>">
                                            <div class="form-row">
                                                <div class="form-group">
                                                    <label for="nama_petugas">Nama petugas</label>
                                                    <input name="nama_petugas" id="nama_petugas" type="text" class="form-control" placeholder="Nama petugas" value="<?=$profile['nama_petugas']?>">
                                                </div>
                                                <div class="form-group">
