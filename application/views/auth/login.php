...
<head>
    ...
    <title>Login Petugas | Aplikasi Pembayaran SPP</title>
	...
	<div class="error-pagewrap">
		<div class="error-page-int">
          ...
          <div class="panel-body container">
            ...
            <!-- ci3 show validation error -->
            <?=validation_errors()?>

            <!-- form login -->
            <form action="<?=site_url('/Auth/doLogin')?>" method="POST" id="loginForm">
                <div class="form-group">
                    <label class="control-label" for="username">Username</label>
                    <input type="text" title="Please enter you username" required="" name="username" id="username" class="form-control" autocomplete="off">
                    <span class="help-block small">Your unique username to app</span>
                </div>
                <div class="form-group">
                    <label class="control-label" for="password">Password</label>
                    <input type="password" title="Please enter your password" required="" name="password" id="password" class="form-control"  autocomplete="off">
                    <span class="help-block small">Your strong password</span>
                </div>
                <button class="btn btn-success btn-block loginbtn">Login</button>
                <!-- link to siswa page login -->
                <div class="text-center" style="margin-top: 5px;">
                  <span>Siswa?</span> <a href="<?=site_url('/Auth/login_siswa')?>">Login di sini</a>
                </div>
            </form>
            <!-- end form login -->
          </div>
			...
			<div class="text-center login-footer">
				<p>Template by <a href="https://colorlib.com/wp/templates/">Colorlib</a>. Backend by Muhamad Syahrul Ramadhan</p>
			</div>
		</div>   
    </div>
    <!-- jquery
